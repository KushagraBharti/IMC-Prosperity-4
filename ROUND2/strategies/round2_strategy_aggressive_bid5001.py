...
class Trader:
    # Round 2 Market Access Fee. Conservative-aggressive: high enough to beat many low/focal bids,
    # but low enough that acceptance should not destroy PnL if the extra volume edge is modest.
    def bid(self):
        return 5001
    ...
    # non-hardcoded fair-value logic. This version is more aggressive than 238191
    # in how quickly it reaches the long carry position, while avoiding passive
    # fill dependence and explicit timestamp/price scripts.
    ...
    def trade_pepper_accumulator(
        ...
        # Ignore one-sided books for the signal model.
        ...
        # No pepper passive quoting by design.
        # The main edge should survive under pessimistic fill assumptions, so pepper
        # relies on visible aggressive accumulation rather than inside-spread rests.
