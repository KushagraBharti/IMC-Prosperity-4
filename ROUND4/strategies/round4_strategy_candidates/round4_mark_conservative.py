...
OPTION_EDGE = {4000: 1.5, 4500: 1.2, 5000: 1.25, 5100: 1.1, 5200: 1.8, 5300: 1.4, 5400: 1.1, 5500: 1.3}
OPTION_SIZE = {4000: 10, 4500: 10, 5000: 10, 5100: 12, 5200: 10, 5300: 8, 5400: 8, 5500: 8}

# Counterparty alpha. Positive weight means follow the Mark's signed flow.
# Negative weight means fade the Mark's signed flow.
VFE_MARK_WEIGHTS = {'Mark 67': 0.02, 'Mark 49': -0.018, 'Mark 55': 0.0045, 'Mark 14': -0.0065, 'Mark 22': -0.01}
HYDRO_MARK_WEIGHTS = {'Mark 14': 0.006, 'Mark 38': -0.006}
VOUCHER_MARK_WEIGHTS = {'Mark 01': 0.0018, 'Mark 22': -0.0018, 'Mark 14': 0.0012}
...
class Trader:
    ...
    OPTION_INV_SKEW = 0.003
    OPTION_DELTA_PENALTY = 0.0
    OPTION_SPOT_MARK_MULT = 0.4

    MARK_DECAY_TAU = 5000.0
    VFE_MARK_CAP = 5.0
    HYDRO_MARK_CAP = 3.0
    VOUCHER_MARK_CAP = 1.0
    HISTORY_LIMIT = 40
