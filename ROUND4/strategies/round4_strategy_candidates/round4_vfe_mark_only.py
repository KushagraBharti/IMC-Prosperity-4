...
ACTIVE_VOUCHERS = ['VEV_5000', 'VEV_5100', 'VEV_5200', 'VEV_5300']
OPTION_EDGE = {4000: 999, 4500: 999, 5000: 1.5, 5100: 1.2, 5200: 2.2, 5300: 1.5, 5400: 999, 5500: 999}
OPTION_SIZE = {4000: 0, 4500: 0, 5000: 10, 5100: 12, 5200: 10, 5300: 8, 5400: 0, 5500: 0}

# Counterparty alpha. Positive weight means follow the Mark's signed flow.
# Negative weight means fade the Mark's signed flow.
VFE_MARK_WEIGHTS = {'Mark 67': 0.022, 'Mark 49': -0.02, 'Mark 55': 0.005, 'Mark 14': -0.008, 'Mark 22': -0.01}
HYDRO_MARK_WEIGHTS = {}
VOUCHER_MARK_WEIGHTS = {}
...
class Trader:
    ...
    OPTION_INV_SKEW = 0.0035
    OPTION_DELTA_PENALTY = 0.0
    OPTION_SPOT_MARK_MULT = 0.5

    MARK_DECAY_TAU = 5000.0
    VFE_MARK_CAP = 6.0
    HYDRO_MARK_CAP = 0.0
    VOUCHER_MARK_CAP = 0.0
    HISTORY_LIMIT = 40
