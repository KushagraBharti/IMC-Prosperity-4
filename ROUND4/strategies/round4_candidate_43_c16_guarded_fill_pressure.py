...
class Trader:
    ...
    OPTION_FILL_PRESSURE_SHORT_DELTA_GUARD = -450.0
    ...
    def trade_vouchers_relative(
        ...
        for symbol in self.ACTIVE_VOUCHERS:
            ...
            pressure = self.option_fill_pressure(cache, symbol)
            if net_delta < self.OPTION_FILL_PRESSURE_SHORT_DELTA_GUARD and delta > 0.15:
                pressure = 0.0
            original_position = position
            orders: List[Order] = []
