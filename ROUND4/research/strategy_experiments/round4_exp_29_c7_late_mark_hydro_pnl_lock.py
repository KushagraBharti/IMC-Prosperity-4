...
class Trader:
    ...
    HYDRO_PNL_LOCK_MIN_TIMESTAMP = 50_000
    HYDRO_PNL_TAKE_TIMESTAMP = 60_000
    HYDRO_PNL_TAKE_PROFIT = 1_100.0
    HYDRO_PNL_PEAK_MIN = 1_250.0
    HYDRO_PNL_MAX_DRAWDOWN = 450.0
    HYDRO_MARK_FAIR_WEIGHT = 1.0
    HYDRO_MARK_EXEC_START_TIMESTAMP = 40_000
        ...
        if hydro_book and hydro_book["has_both_sides"]:
            ...
            if timestamp >= self.TRADE_START_TIMESTAMP:
                if timestamp >= self.HYDRO_EXIT_TIMESTAMP or hydro_locked:
                    ...
                    if timestamp >= self.HYDRO_MARK_EXEC_START_TIMESTAMP:
