...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        if hydro_book and hydro_book["has_both_sides"]:
            ...
            if hydro_locked:
                if not bool(cache.get("hydro_lock", False)):
                    print("HYDRO_LOCK", timestamp, "pos", hydro_pos, "pnl", cache.get("hydro_pnl"), "peak", cache.get("hydro_pnl_peak"), "cash", cache.get("hydro_cash"))
