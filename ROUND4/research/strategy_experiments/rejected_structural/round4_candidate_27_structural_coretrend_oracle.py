...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        self.apply_target_overlay(results, books, state.position, timestamp)
    ...
    def apply_target_overlay(
        ...
        targets = None
        for start, schedule_targets in self.TARGET_SCHEDULE:
            if timestamp >= start:
