...
class Trader:
    ...
    OPTION_MM_START_TIMESTAMP = 10_000
    OPTION_MM_SYMBOLS = {"VEV_4000", "VEV_4500"}
    OPTION_MM_SIZE = 60
    OPTION_MM_SOFT_LIMIT = 300
    OPTION_MM_FAIR_GUARD = 1.00
    ...
    def add_option_market_maker_orders(
        ...
        mid = float(book["mid"])
        fair_guard = max(8.0, self.OPTION_MM_FAIR_GUARD * spread)
