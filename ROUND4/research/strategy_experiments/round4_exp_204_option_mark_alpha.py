...
class Trader:
    ...
    OPTION_MARK_WEIGHTS = {
        "VEV_5000": {"Mark 38": 1.0, "Mark 22": -1.0},
        "VEV_5100": {"Mark 38": 1.0, "Mark 22": -1.0},
        "VEV_5200": {"Mark 22": -1.0},
        "VEV_5300": {"Mark 14": 1.0, "Mark 22": 0.5},
        "VEV_5400": {"Mark 14": -1.0, "Mark 22": 0.5},
        "VEV_5500": {"Mark 01": -0.5, "Mark 22": 0.5},
    }
    ...
    def trade_vouchers_relative(
        ...
        for symbol in self.ACTIVE_VOUCHERS:
            ...
            fair += self.OPTION_MARK_FAIR_WEIGHT * self.mark_flow_signal(
                cache,
                state,
                symbol,
                self.OPTION_MARK_WEIGHTS.get(symbol, {}),
                f"option_mark_flow_{symbol}",
            )
