...
class Trader:
    ...
    # Osmium: stationary around 10_000, best handled as a spread-capturing MM with light alpha tilt.
    OSMIUM_FAIR = 10000.0
    OSMIUM_BASE_SIZE = 20
    ...
    # Pepper: rising trend with stable anchor, best handled as long-biased trend accumulation.
    PEPPER_TREND_PER_TIMESTAMP = 0.001
    PEPPER_DEFAULT_ANCHOR = 13000.0
    PEPPER_FORWARD_PREMIUM = 6.0
    PEPPER_BASE_TARGET = 66
