...
class Trader:
    ...
    # Pepper: aggressive carry accumulator with extremely selective micro-trims.
    # The core idea is still to get long quickly and stay long. Trims are only
    # allowed on very rich residual spikes with supportive negative microstructure,
    # so the design stays close to the accumulator while offering one alternative
    # path if the portal rewards a tiny amount of tactical recycling.
    ...
    PEPPER_TRIM_RESIDUAL = 5.0
    PEPPER_RELOAD_RESIDUAL = -0.5
    PEPPER_TRIM_BIAS = 1.5
    PEPPER_TRIM_ALPHA = 0.10
    PEPPER_TRIM_EDGE = 2.5
    PEPPER_TRIM_FLOOR = 78
    PEPPER_TRIM_SIZE = 2
    PEPPER_SELL_DEV_THRESH = -1.0
    PEPPER_SELL_IMB_THRESH = -0.3
