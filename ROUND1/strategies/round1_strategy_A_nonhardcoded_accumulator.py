...
class Trader:
    ...
    # Pepper: non-hardcoded carry accumulator.
    # Design goal: get the same economics as the portal-window hold winner,
    # but through a general trend-fair rule rather than timestamp/price hardcoding.
    ...
    PEPPER_BASE_TARGET = 80
    PEPPER_TARGET_SLOPE = 4
    ...
    PEPPER_CATCHUP_EDGE_LARGE = -0.60
    PEPPER_LARGE_GAP = 12
    ...
    def trade_pepper_accumulator(
        ...
        # Small non-essential passive bid when we are still materially under target.
        # It is intentionally capped; the strategy should still work if this never fills.
