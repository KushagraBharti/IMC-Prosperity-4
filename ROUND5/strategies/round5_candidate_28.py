...
class Trader:
    ...
    PEB_AGGRESSION = 0.96
    PEB_ALLOW_TAKE = 1
    SIGNAL_CONFIG = {'GALAXY_SOUNDS_PLANETARY_RINGS': ('breakout_low_reversal', 200, 0.9, 1.0, 'passive'), 'ROBOT_IRONING': ('vol_norm_momentum', 100, 0.94, 1.1, 'passive'), 'OXYGEN_SHAKE_EVENING_BREATH': ('reversal', 100, 0.96, 1.0, 'passive'), 'MICROCHIP_TRIANGLE': ('reversal', 50, 0.98, 0.9, 'passive'), 'SLEEP_POD_SUEDE': ('reversal', 100, 1.05, 0.82, 'passive'), 'OXYGEN_SHAKE_GARLIC': ('reversal', 200, 0.92, 1.05, 'passive'), 'UV_VISOR_ORANGE': ('momentum', 200, 0.96, 1.05, 'passive'), 'MICROCHIP_OVAL': ('breakout_low_reversal', 200, 0.9, 0.95, 'passive'), 'SLEEP_POD_COTTON': ('momentum', 100, 1.0, 0.8, 'passive')}
    MAX_SIGNAL_PRODUCTS = 12
