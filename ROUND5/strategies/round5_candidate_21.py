...
class Trader:
    ...
    SIGNAL_CONFIG = {'MICROCHIP_SQUARE': ('reversal', 100, 0.9, 1.1), 'GALAXY_SOUNDS_PLANETARY_RINGS': ('momentum', 100, 0.95, 1.0), 'ROBOT_LAUNDRY': ('momentum', 100, 0.95, 1.0), 'OXYGEN_SHAKE_EVENING_BREATH': ('reversal', 100, 0.95, 1.0), 'MICROCHIP_TRIANGLE': ('reversal', 50, 0.95, 1.0), 'ROBOT_IRONING': ('momentum', 100, 0.95, 1.0), 'UV_VISOR_AMBER': ('momentum', 100, 0.95, 1.0), 'MICROCHIP_OVAL': ('momentum', 100, 1.05, 0.85), 'SLEEP_POD_SUEDE': ('reversal', 100, 1.05, 0.85)}
