...
class Trader:
    ...
    PEB_AGGRESSION = 0.96
    PEB_ALLOW_TAKE = 1
    SIGNAL_CONFIG = {'MICROCHIP_OVAL': ('breakout_low_reversal', 200, 0.8, 1.2, 'passive'), 'MICROCHIP_SQUARE': ('breakout_low_reversal', 200, 0.74, 1.25, 'passive'), 'MICROCHIP_RECTANGLE': ('breakout_low_reversal', 200, 0.82, 1.05, 'passive'), 'MICROCHIP_TRIANGLE': ('rolling_mean_reversion', 100, 0.92, 0.75, 'passive'), 'UV_VISOR_ORANGE': ('momentum', 200, 1.05, 0.8, 'passive'), 'ROBOT_IRONING': ('vol_norm_momentum', 100, 1.05, 0.75, 'passive')}
    MAX_SIGNAL_PRODUCTS = 9
