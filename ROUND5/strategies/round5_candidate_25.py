...
class Trader:
    ...
    SIGNAL_CONFIG = {'MICROCHIP_SQUARE': ('reversal', 100, 0.95, 1.0), 'ROBOT_LAUNDRY': ('momentum', 100, 1.0, 0.95), 'OXYGEN_SHAKE_EVENING_BREATH': ('reversal', 100, 1.0, 0.9), 'MICROCHIP_TRIANGLE': ('reversal', 50, 1.0, 0.9), 'ROBOT_IRONING': ('momentum', 100, 1.0, 0.9), 'UV_VISOR_AMBER': ('momentum', 100, 1.0, 0.9), 'UV_VISOR_ORANGE': ('momentum', 100, 1.0, 1.1), 'SLEEP_POD_COTTON': ('momentum', 100, 1.0, 1.0), 'TRANSLATOR_GRAPHITE_MIST': ('momentum', 100, 1.15, 0.7)}
    MAX_SIGNAL_PRODUCTS = 7
