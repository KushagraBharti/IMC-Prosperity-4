...
class Trader:
    LIMIT = 10
    CONFIG = {
        "MICROCHIP_SQUARE": ("reversal", 100, 0.90),
        "GALAXY_SOUNDS_PLANETARY_RINGS": ("momentum", 100, 0.95),
        "ROBOT_LAUNDRY": ("momentum", 100, 0.95),
        "OXYGEN_SHAKE_EVENING_BREATH": ("reversal", 100, 0.95),
        "MICROCHIP_TRIANGLE": ("reversal", 50, 0.95),
        "ROBOT_IRONING": ("momentum", 100, 0.95),
        "UV_VISOR_AMBER": ("momentum", 100, 0.95),
        "MICROCHIP_OVAL": ("momentum", 100, 1.05),
        "SLEEP_POD_SUEDE": ("reversal", 100, 1.05),
    }
