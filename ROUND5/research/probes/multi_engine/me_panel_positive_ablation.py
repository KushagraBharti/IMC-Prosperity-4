...
class Trader:
    LIMIT = 10
    CONFIG = {'PANEL_4X4': ('momentum', 50, 0.8, 1.3), 'PANEL_1X2': ('breakout_low_reversal', 200, 1.0, 0.6), 'PANEL_1X4': ('breakout_low_reversal', 200, 1.0, 0.6), 'PANEL_2X2': ('breakout_low_reversal', 200, 1.0, 0.7)}
    MAX_ACTIVE = 10
