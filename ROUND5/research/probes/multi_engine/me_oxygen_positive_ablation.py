...
class Trader:
    LIMIT = 10
    CONFIG = {'OXYGEN_SHAKE_MORNING_BREATH': ('breakout_high', 200, 1.0, 0.7), 'OXYGEN_SHAKE_CHOCOLATE': ('rolling_mean_reversion', 200, 1.0, 0.7), 'OXYGEN_SHAKE_GARLIC': ('reversal', 200, 0.85, 1.3), 'OXYGEN_SHAKE_MINT': ('breakout_low_reversal', 200, 1.0, 0.6), 'OXYGEN_SHAKE_EVENING_BREATH': ('breakout_low_reversal', 200, 0.95, 0.8)}
    MAX_ACTIVE = 10
