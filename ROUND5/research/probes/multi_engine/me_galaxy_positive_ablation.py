...
class Trader:
    LIMIT = 10
    CONFIG = {'GALAXY_SOUNDS_DARK_MATTER': ('breakout_high', 200, 1.0, 0.8), 'GALAXY_SOUNDS_SOLAR_FLAMES': ('rolling_mean_reversion', 200, 1.0, 0.8), 'GALAXY_SOUNDS_SOLAR_WINDS': ('rolling_mean_reversion', 200, 1.0, 0.7), 'GALAXY_SOUNDS_PLANETARY_RINGS': ('breakout_low_reversal', 200, 0.85, 1.0)}
    MAX_ACTIVE = 10
