...
class Trader:
    LIMIT = 10
    CONFIG = {'MICROCHIP_SQUARE': ('breakout_low_reversal', 200, 0.95, 1.0, 'hybrid'), 'MICROCHIP_TRIANGLE': ('rolling_mean_reversion', 100, 0.95, 0.9, 'hybrid'), 'MICROCHIP_RECTANGLE': ('breakout_low_reversal', 200, 1.0, 0.8, 'hybrid')}
    MAX_ACTIVE = 10
