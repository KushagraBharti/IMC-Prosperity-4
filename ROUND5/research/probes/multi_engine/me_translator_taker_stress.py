...
class Trader:
    LIMIT = 10
    CONFIG = {'TRANSLATOR_GRAPHITE_MIST': ('breakout_low_reversal', 100, 1.0, 0.9, 'hybrid'), 'TRANSLATOR_VOID_BLUE': ('breakout_low_reversal', 100, 1.0, 0.8, 'hybrid'), 'TRANSLATOR_SPACE_GRAY': ('breakout_high', 200, 1.05, 0.7, 'hybrid')}
    MAX_ACTIVE = 10
