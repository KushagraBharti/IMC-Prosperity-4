...
class Trader:
    LIMIT = 10
    CONFIG = {'UV_VISOR_ORANGE': ('momentum', 200, 0.85, 1.1), 'UV_VISOR_RED': ('momentum', 200, 0.95, 0.8), 'UV_VISOR_AMBER': ('breakout_low_reversal', 200, 0.95, 0.7), 'UV_VISOR_YELLOW': ('breakout_low_reversal', 200, 1.0, 0.6), 'UV_VISOR_MAGENTA': ('breakout_low_reversal', 200, 1.0, 0.6)}
    MAX_ACTIVE = 10
