...
class Trader:
    LIMIT = 10
    CONFIG = {'SLEEP_POD_COTTON': ('vol_norm_momentum', 200, 0.9, 1.2), 'SLEEP_POD_LAMB_WOOL': ('breakout_low_reversal', 200, 0.95, 0.8), 'SLEEP_POD_NYLON': ('rolling_mean_reversion', 100, 0.9, 0.8)}
    MAX_ACTIVE = 10
