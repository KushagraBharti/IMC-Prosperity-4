...
class Trader:
    LIMIT = 10
    CONFIG = {'ROBOT_DISHES': ('breakout_low_reversal', 100, 1.0, 0.7), 'ROBOT_MOPPING': ('rolling_mean_reversion', 100, 0.85, 1.0), 'ROBOT_LAUNDRY': ('breakout_low_reversal', 200, 0.95, 0.8), 'ROBOT_IRONING': ('momentum', 100, 0.85, 1.0)}
    MAX_ACTIVE = 10
