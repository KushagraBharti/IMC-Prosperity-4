...
class Trader:
    LIMIT = 10
    CONFIG = {'TRANSLATOR_GRAPHITE_MIST': ('breakout_low_reversal', 100, 0.85, 1.0), 'TRANSLATOR_VOID_BLUE': ('breakout_low_reversal', 100, 0.9, 0.9), 'TRANSLATOR_ASTRO_BLACK': ('breakout_low_reversal', 100, 1.0, 0.6), 'TRANSLATOR_SPACE_GRAY': ('breakout_high', 200, 1.0, 0.6), 'TRANSLATOR_ECLIPSE_CHARCOAL': ('rolling_mean_reversion', 200, 1.0, 0.6)}
    MAX_ACTIVE = 10
