...
class Trader:
    LIMIT = 10
    CONFIG = {'MICROCHIP_SQUARE': ('breakout_low_reversal', 200, 0.75, 1.2), 'MICROCHIP_TRIANGLE': ('rolling_mean_reversion', 100, 0.85, 1.0), 'MICROCHIP_RECTANGLE': ('breakout_low_reversal', 200, 0.85, 0.9), 'MICROCHIP_OVAL': ('breakout_low_reversal', 200, 0.85, 1.0)}
    MAX_ACTIVE = 10
