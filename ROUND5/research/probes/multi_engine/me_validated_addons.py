...
class Trader:
    LIMIT = 10
    CONFIG = {'OXYGEN_SHAKE_GARLIC': ('reversal', 200, 0.85, 1.3), 'PANEL_4X4': ('momentum', 50, 0.8, 1.3), 'UV_VISOR_ORANGE': ('momentum', 200, 0.85, 1.1), 'ROBOT_IRONING': ('momentum', 100, 0.85, 1.0), 'MICROCHIP_OVAL': ('breakout_low_reversal', 200, 0.9, 0.9)}
    MAX_ACTIVE = 10
