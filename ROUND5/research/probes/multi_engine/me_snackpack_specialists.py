...
class Trader:
    LIMIT = 10
    CONFIG = {'SNACKPACK_RASPBERRY': ('breakout_low_reversal', 200, 1.0, 0.8), 'SNACKPACK_STRAWBERRY': ('breakout_low_reversal', 200, 1.0, 0.8), 'SNACKPACK_CHOCOLATE': ('rolling_mean_reversion', 200, 1.0, 0.6), 'SNACKPACK_VANILLA': ('rolling_mean_reversion', 200, 1.0, 0.6), 'SNACKPACK_PISTACHIO': ('breakout_low_reversal', 200, 1.0, 0.6)}
    MAX_ACTIVE = 10
