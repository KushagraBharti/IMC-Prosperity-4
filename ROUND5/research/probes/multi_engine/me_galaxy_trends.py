...
class Trader:
    LIMIT = 10
    CONFIG = {'GALAXY_SOUNDS_PLANETARY_RINGS': ('breakout_low_reversal', 200, 0.85, 1.0), 'GALAXY_SOUNDS_SOLAR_WINDS': ('rolling_mean_reversion', 200, 1.0, 0.6), 'GALAXY_SOUNDS_DARK_MATTER': ('breakout_high', 200, 1.0, 0.6), 'GALAXY_SOUNDS_BLACK_HOLES': ('rolling_mean_reversion', 200, 1.0, 0.6), 'GALAXY_SOUNDS_SOLAR_FLAMES': ('rolling_mean_reversion', 200, 1.0, 0.6)}
    MAX_ACTIVE = 10
