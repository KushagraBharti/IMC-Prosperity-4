...
class Trader:
    ...
    PEB_AGGRESSION = 1.02
    PEB_ALLOW_TAKE = 1
    SIGNAL_CONFIG = {'UV_VISOR_ORANGE': ('momentum', 200, 0.9, 1.2, 'passive'), 'SLEEP_POD_COTTON': ('momentum', 100, 0.95, 1.05, 'passive'), 'ROBOT_IRONING': ('vol_norm_momentum', 100, 0.9, 1.1, 'passive'), 'MICROCHIP_TRIANGLE': ('reversal', 50, 0.98, 0.8, 'passive'), 'OXYGEN_SHAKE_EVENING_BREATH': ('reversal', 100, 0.98, 0.85, 'passive'), 'OXYGEN_SHAKE_GARLIC': ('reversal', 200, 0.84, 1.25, 'passive'), 'PANEL_4X4': ('momentum', 50, 0.78, 1.3, 'passive'), 'MICROCHIP_OVAL': ('breakout_low_reversal', 200, 0.82, 1.15, 'passive'), 'MICROCHIP_SQUARE': ('breakout_low_reversal', 200, 0.82, 1.0, 'passive'), 'MICROCHIP_RECTANGLE': ('breakout_low_reversal', 200, 0.92, 0.78, 'passive'), 'GALAXY_SOUNDS_PLANETARY_RINGS': ('breakout_low_reversal', 200, 0.88, 1.0, 'passive'), 'TRANSLATOR_SPACE_GRAY': ('breakout_high', 500, 0.98, 0.85, 'passive'), 'TRANSLATOR_ECLIPSE_CHARCOAL': ('rolling_mean_reversion', 500, 1.0, 0.75, 'passive'), 'PANEL_1X2': ('breakout_low_reversal', 200, 1.0, 0.65, 'passive'), 'PANEL_1X4': ('breakout_low_reversal', 200, 1.0, 0.62, 'passive'), 'GALAXY_SOUNDS_DARK_MATTER': ('breakout_high', 200, 1.04, 0.58, 'passive'), 'OXYGEN_SHAKE_MORNING_BREATH': ('breakout_high', 200, 1.0, 0.62, 'passive')}
    MAX_SIGNAL_PRODUCTS = 17
