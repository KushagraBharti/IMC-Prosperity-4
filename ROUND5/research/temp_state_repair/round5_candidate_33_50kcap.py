...
class Trader:
    ...
    PEB_AGGRESSION = 1.05
    PEB_ALLOW_TAKE = 1
    SIGNAL_CONFIG = {'OXYGEN_SHAKE_GARLIC': ('reversal', 200, 0.82, 1.3, 'passive'), 'UV_VISOR_ORANGE': ('momentum', 200, 0.86, 1.25, 'passive'), 'PANEL_4X4': ('momentum', 50, 0.76, 1.35, 'passive'), 'ROBOT_IRONING': ('vol_norm_momentum', 100, 0.88, 1.1, 'passive'), 'MICROCHIP_OVAL': ('breakout_low_reversal', 200, 0.8, 1.15, 'passive'), 'GALAXY_SOUNDS_DARK_MATTER': ('breakout_high', 200, 0.96, 0.85, 'passive'), 'GALAXY_SOUNDS_SOLAR_FLAMES': ('rolling_mean_reversion', 200, 0.96, 0.78, 'passive'), 'GALAXY_SOUNDS_SOLAR_WINDS': ('rolling_mean_reversion', 200, 1.02, 0.65, 'passive'), 'GALAXY_SOUNDS_PLANETARY_RINGS': ('breakout_low_reversal', 200, 0.84, 1.05, 'passive'), 'TRANSLATOR_SPACE_GRAY': ('breakout_high', 500, 0.92, 1.1, 'passive'), 'TRANSLATOR_ECLIPSE_CHARCOAL': ('rolling_mean_reversion', 500, 0.94, 0.95, 'passive'), 'PANEL_1X2': ('breakout_low_reversal', 200, 0.96, 0.75, 'passive'), 'PANEL_1X4': ('breakout_low_reversal', 200, 0.96, 0.72, 'passive'), 'PANEL_2X2': ('breakout_low_reversal', 200, 1.02, 0.55, 'passive'), 'OXYGEN_SHAKE_MORNING_BREATH': ('breakout_high', 200, 0.92, 0.95, 'passive'), 'OXYGEN_SHAKE_CHOCOLATE': ('rolling_mean_reversion', 200, 0.98, 0.75, 'passive'), 'OXYGEN_SHAKE_EVENING_BREATH': ('reversal', 100, 0.98, 0.8, 'passive'), 'OXYGEN_SHAKE_MINT': ('breakout_low_reversal', 500, 1.02, 0.58, 'passive'), 'UV_VISOR_RED': ('momentum', 200, 0.94, 0.82, 'passive'), 'UV_VISOR_YELLOW': ('breakout_low_reversal', 500, 1.0, 0.58, 'passive'), 'SLEEP_POD_COTTON': ('momentum', 100, 0.94, 1.0, 'passive'), 'SLEEP_POD_LAMB_WOOL': ('breakout_low_reversal', 500, 0.98, 0.72, 'passive'), 'SLEEP_POD_NYLON': ('rolling_mean_reversion', 200, 1.02, 0.55, 'passive'), 'MICROCHIP_SQUARE': ('breakout_low_reversal', 200, 0.78, 1.15, 'passive'), 'MICROCHIP_RECTANGLE': ('breakout_low_reversal', 200, 0.88, 0.95, 'passive')}
    MAX_SIGNAL_PRODUCTS = 24
