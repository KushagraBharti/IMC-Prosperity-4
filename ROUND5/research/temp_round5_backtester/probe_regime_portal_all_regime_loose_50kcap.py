...
# Temporary regime-gap probe: probe_regime_portal_all_regime_loose
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ...
    REGIME_GAP_CONFIG = {'SNACKPACK_STRAWBERRY': ('reversal',
                          200,
                          0.8200000000000001,
                          1.2100000000000002,
                          'passive',
 ...
 'SNACKPACK_PISTACHIO': ('reversal',
                         ...
                         'imbalance_extreme',
                         0.33999999999999997),
 'SNACKPACK_CHOCOLATE': ('momentum', 200, 0.8400000000000001, 0.9900000000000001, 'passive', 'spread_low', 10.0),
 'SNACKPACK_VANILLA': ('momentum', 200, 0.9, 0.77, 'passive', 'spread_low', 10.0),
 'UV_VISOR_MAGENTA': ('momentum', 50, 0.78, 1.1, 'passive', 'imbalance_extreme', 0.37),
 'UV_VISOR_YELLOW': ('reversal', 200, 0.8, 0.935, 'passive', 'spread_low', 11.0),
 'SLEEP_POD_SUEDE': ('reversal', 100, 0.76, 1.265, 'passive', 'spread_low', 11.0),
 'SLEEP_POD_POLYESTER': ('reversal', 200, 0.8, 1.1, 'passive', 'imbalance_extreme', 0.33999999999999997),
 'SLEEP_POD_LAMB_WOOL': ('momentum', 200, 0.78, 1.045, 'passive', 'imbalance_extreme', 0.33999999999999997),
 'GALAXY_SOUNDS_BLACK_HOLES': ('reversal', 50, 0.78, 1.1, 'passive', 'imbalance_extreme', 0.37),
 'GALAXY_SOUNDS_SOLAR_FLAMES': ('reversal', 200, 0.8, 0.9900000000000001, 'passive', 'spread_low', 12.0),
 'OXYGEN_SHAKE_EVENING_BREATH': ('reversal', 100, 0.76, 1.1, 'passive', 'spread_low', 12.0),
 'OXYGEN_SHAKE_MINT': ('reversal', 200, 0.8, 0.9900000000000001, 'passive', 'spread_low', 12.0),
 'OXYGEN_SHAKE_MORNING_BREATH': ('momentum', 200, 0.78, 1.045, 'passive', 'spread_low', 12.0),
 'OXYGEN_SHAKE_CHOCOLATE': ('reversal', 200, 0.78, 1.045, 'passive', 'imbalance_extreme', 0.33999999999999997)}
