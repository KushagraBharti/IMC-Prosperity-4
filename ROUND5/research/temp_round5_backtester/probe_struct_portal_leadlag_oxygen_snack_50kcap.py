...
# Temporary fresh structural probe: probe_struct_portal_leadlag_oxygen_snack
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ...
    LEAD_LAG_CONFIG = {'OXYGEN_SHAKE_MORNING_BREATH': ('OXYGEN_SHAKE_GARLIC', 100, 0.86, 1.0, 1.0, 'passive'),
