...
# Temporary executable 150k probe: probe_c36_plus_c35_clean_signals
class Trader:
    LIMIT = 10
    ANCHOR = 10_000
    ...
    SIGNAL_CONFIG = {'OXYGEN_SHAKE_GARLIC': ('reversal', 200, 0.82, 1.3),
     'UV_VISOR_ORANGE': ('momentum', 200, 0.86, 1.25),
     'PANEL_4X4': ('momentum', 50, 0.76, 1.35),
     'ROBOT_IRONING': ('vol_norm_momentum', 100, 0.88, 1.1),
     'MICROCHIP_OVAL': ('breakout_low_reversal', 200, 0.8, 1.15),
     'GALAXY_SOUNDS_DARK_MATTER': ('breakout_high', 200, 0.96, 0.85),
     'GALAXY_SOUNDS_SOLAR_FLAMES': ('rolling_mean_reversion', 200, 0.96, 0.78),
     'GALAXY_SOUNDS_SOLAR_WINDS': ('rolling_mean_reversion', 200, 1.02, 0.65),
     'GALAXY_SOUNDS_PLANETARY_RINGS': ('breakout_low_reversal', 200, 0.84, 1.05),
     'TRANSLATOR_SPACE_GRAY': ('breakout_high', 500, 0.92, 1.1),
     'TRANSLATOR_ECLIPSE_CHARCOAL': ('rolling_mean_reversion', 500, 0.94, 0.95),
     'PANEL_1X2': ('breakout_low_reversal', 200, 0.96, 0.75),
     'PANEL_1X4': ('breakout_low_reversal', 200, 0.96, 0.72),
     'PANEL_2X2': ('breakout_low_reversal', 200, 1.02, 0.55),
     'OXYGEN_SHAKE_MORNING_BREATH': ('breakout_high', 200, 0.92, 0.95),
     'OXYGEN_SHAKE_CHOCOLATE': ('rolling_mean_reversion', 200, 0.98, 0.75),
     'OXYGEN_SHAKE_EVENING_BREATH': ('reversal', 100, 0.98, 0.8),
     'OXYGEN_SHAKE_MINT': ('breakout_low_reversal', 500, 1.02, 0.58),
     'UV_VISOR_RED': ('momentum', 200, 0.94, 0.82),
     'UV_VISOR_YELLOW': ('breakout_low_reversal', 500, 1.0, 0.58),
     'SLEEP_POD_COTTON': ('momentum', 100, 0.94, 1.0),
     'SLEEP_POD_LAMB_WOOL': ('breakout_low_reversal', 500, 0.98, 0.72),
     'SLEEP_POD_NYLON': ('rolling_mean_reversion', 200, 1.02, 0.55),
     'MICROCHIP_SQUARE': ('breakout_low_reversal', 200, 0.78, 1.15),
     'MICROCHIP_RECTANGLE': ('breakout_low_reversal', 200, 0.88, 0.95),
     'TRANSLATOR_GRAPHITE_MIST': ('momentum', 100, 1.1, 0.9),
     'TRANSLATOR_VOID_BLUE': ('reversal', 100, 1.0, 0.8),
     'SLEEP_POD_POLYESTER': ('reversal', 100, 1.0, 0.9),
     'PANEL_2X4': ('momentum', 50, 0.86, 1.0),
     'SLEEP_POD_SUEDE': ('reversal', 100, 0.94, 1.0),
     'GALAXY_SOUNDS_BLACK_HOLES': ('reversal', 50, 0.98, 0.75),
     'TRANSLATOR_ASTRO_BLACK': ('momentum', 100, 1.0, 0.75),
     'SNACKPACK_STRAWBERRY': ('reversal', 200, 1.08, 0.6),
     'SNACKPACK_RASPBERRY': ('reversal', 200, 1.08, 0.55),
     'SNACKPACK_PISTACHIO': ('reversal', 200, 1.08, 0.5),
     'ROBOT_VACUUMING': ('reversal', 200, 1.02, 0.55)}
