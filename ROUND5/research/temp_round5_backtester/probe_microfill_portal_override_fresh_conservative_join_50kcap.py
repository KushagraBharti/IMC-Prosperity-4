...
# Temporary microstructure fill probe: probe_microfill_portal_override_fresh_conservative_join
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ...
    MICRO_FILL_CONFIG = {'PANEL_1X2': (0.38, 0.8, 3, 3, 'join'),
 'PANEL_1X4': (0.38, 0.85, 3, 3, 'join'),
 'PANEL_2X2': (0.38, 0.8, 3, 3, 'join'),
 'PANEL_2X4': (0.36, 1.0, 4, 3, 'join'),
 'PANEL_4X4': (0.4, 0.9, 3, 3, 'join'),
 'SLEEP_POD_COTTON': (0.4, 0.85, 3, 3, 'join'),
 'SLEEP_POD_POLYESTER': (0.38, 0.9, 3, 3, 'join'),
 'SLEEP_POD_SUEDE': (0.36, 1.0, 4, 3, 'join'),
 'SLEEP_POD_LAMB_WOOL': (0.38, 0.9, 3, 3, 'join'),
 'SLEEP_POD_NYLON': (0.4, 0.8, 3, 3, 'join'),
 'TRANSLATOR_ASTRO_BLACK': (0.38, 0.95, 3, 3, 'join'),
 'TRANSLATOR_SPACE_GRAY': (0.36, 1.05, 4, 3, 'join'),
 'GALAXY_SOUNDS_BLACK_HOLES': (0.38, 0.95, 3, 3, 'join'),
 'GALAXY_SOUNDS_PLANETARY_RINGS': (0.4, 0.85, 3, 3, 'join'),
 'OXYGEN_SHAKE_GARLIC': (0.38, 1.0, 3, 3, 'join'),
 'OXYGEN_SHAKE_MINT': (0.38, 0.9, 3, 3, 'join'),
 'SNACKPACK_VANILLA': (0.36, 0.9, 3, 3, 'join'),
 'SNACKPACK_CHOCOLATE': (0.36, 0.9, 3, 3, 'join')}
