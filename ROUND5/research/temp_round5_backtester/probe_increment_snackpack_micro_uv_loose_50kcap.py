...
# Temporary executable 150k probe: probe_increment_snackpack_micro_uv_loose
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ANCHOR_PRODUCTS = {'SNACKPACK_CHOCOLATE', 'PEBBLES_L', 'SNACKPACK_VANILLA', 'SNACKPACK_RASPBERRY', 'TRANSLATOR_ECLIPSE_CHARCOAL'}
