...
# Temporary fresh-edge pivot probe: probe_pivot_portal_all_fresh_no_robot_micro_uv
# Hand-integrated mechanism probe: probe_hand_portal_fresh_micro_anchor_passive
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ...
    MICRO_ANCHOR_EDGE = 10.0
    MICRO_ANCHOR_SIZE = 6
    MICRO_ANCHOR_TAKE_EXTRA = 99.0
