...
# Temporary missing-mechanism executable probe: probe_missing_portal_micro_square_anchor_take
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ...
    PRODUCT_ANCHOR_CONFIG = {'MICROCHIP_SQUARE': (14250.0, 16.0, 10, 'sell_high', 'take')}
