...
# Temporary executable 150k probe: probe_sleep_uv_snack
class Trader:
    LIMIT = 10
    ...
    SIGNAL_CONFIG = {'OXYGEN_SHAKE_GARLIC': ('reversal', 200, 0.82, 1.3, 'passive'),
     ...
     'UV_VISOR_MAGENTA': ('momentum', 50, 0.94, 0.9, 'passive'),
     'UV_VISOR_AMBER': ('momentum', 150, 0.86, 0.85, 'passive'),
     'SNACKPACK_STRAWBERRY': ('reversal', 200, 1.02, 0.7, 'passive'),
     'SNACKPACK_RASPBERRY': ('reversal', 200, 1.04, 0.65, 'passive'),
     'SNACKPACK_CHOCOLATE': ('momentum', 200, 1.02, 0.6, 'passive'),
     'SNACKPACK_PISTACHIO': ('reversal', 200, 1.04, 0.55, 'passive'),
     'SNACKPACK_VANILLA': ('momentum', 200, 1.08, 0.5, 'passive')}
    MAX_SIGNAL_PRODUCTS = 34
