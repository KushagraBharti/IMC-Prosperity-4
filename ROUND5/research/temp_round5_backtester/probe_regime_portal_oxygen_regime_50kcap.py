...
# Temporary regime-gap probe: probe_regime_portal_oxygen_regime
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ...
    REGIME_GAP_CONFIG = {'OXYGEN_SHAKE_EVENING_BREATH': ('reversal', 100, 0.84, 1.0, 'passive', 'spread_low', 12.0),
 'OXYGEN_SHAKE_MINT': ('reversal', 200, 0.88, 0.9, 'passive', 'spread_low', 12.0),
