...
class Trader:
    ...
    PEB_AGGRESSION = 1.08
    PEB_ALLOW_TAKE = 1
    SIGNAL_CONFIG = {'OXYGEN_SHAKE_GARLIC': ('reversal', 200, 0.7544, 1.534, 'passive'),
     'UV_VISOR_ORANGE': ('momentum', 200, 0.7912, 1.475, 'passive'),
     'PANEL_4X4': ('momentum', 50, 0.6624, 1.711, 'passive'),
     'ROBOT_IRONING': ('vol_norm_momentum', 100, 0.88, 1.1, 'passive'),
     'MICROCHIP_OVAL': ('breakout_low_reversal', 200, 0.736, 1.357, 'passive'),
     ...
     'GALAXY_SOUNDS_PLANETARY_RINGS': ('breakout_low_reversal', 200, 0.7728, 1.239, 'passive'),
     ...
     'SLEEP_POD_COTTON': ('momentum', 100, 0.8648, 1.18, 'passive'),
     ...
     'MICROCHIP_SQUARE': ('breakout_low_reversal', 200, 0.7176, 1.357, 'passive'),
