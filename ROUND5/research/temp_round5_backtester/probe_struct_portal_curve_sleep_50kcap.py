...
# Temporary fresh structural probe: probe_struct_portal_curve_sleep
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ...
    SEMANTIC_CURVES = {'SLEEP': (['SLEEP_POD_COTTON', 'SLEEP_POD_POLYESTER', 'SLEEP_POD_SUEDE', 'SLEEP_POD_LAMB_WOOL', 'SLEEP_POD_NYLON'],
