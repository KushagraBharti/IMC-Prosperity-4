...
class Trader:
    ...
    HYBRID_PRODUCTS = {'GALAXY_SOUNDS_PLANETARY_RINGS','GALAXY_SOUNDS_DARK_MATTER','GALAXY_SOUNDS_SOLAR_FLAMES','GALAXY_SOUNDS_SOLAR_WINDS','GALAXY_SOUNDS_BLACK_HOLES'}
