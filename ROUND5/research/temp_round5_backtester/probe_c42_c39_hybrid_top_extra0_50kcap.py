...
class Trader:
    ...
    HYBRID_PRODUCTS = {'PANEL_4X4','PANEL_1X2','PANEL_1X4','PANEL_2X2','PANEL_2X4','MICROCHIP_OVAL','MICROCHIP_SQUARE','MICROCHIP_RECTANGLE','MICROCHIP_TRIANGLE','UV_VISOR_ORANGE','UV_VISOR_AMBER','GALAXY_SOUNDS_PLANETARY_RINGS'}
