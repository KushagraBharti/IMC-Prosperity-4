...
# Temporary fresh structural probe: probe_struct_portal_leadlag_all_fresh
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ...
    LEAD_LAG_CONFIG = {'PANEL_1X2': ('PANEL_4X4', 100, 0.92, 0.8, 1.0, 'passive'),
 'PANEL_1X4': ('PANEL_4X4', 100, 0.9, 0.9, 1.0, 'passive'),
 ...
 'SLEEP_POD_SUEDE': ('SLEEP_POD_COTTON', 100, 0.9, 1.05, -1.0, 'passive'),
 'SLEEP_POD_LAMB_WOOL': ('SLEEP_POD_COTTON', 200, 0.9, 0.95, 1.0, 'passive'),
 'SLEEP_POD_NYLON': ('SLEEP_POD_COTTON', 100, 0.92, 0.85, -1.0, 'passive'),
 'TRANSLATOR_GRAPHITE_MIST': ('TRANSLATOR_SPACE_GRAY', 200, 0.82, 1.0, 1.0, 'passive'),
 'TRANSLATOR_VOID_BLUE': ('TRANSLATOR_SPACE_GRAY', 200, 0.86, 0.9, -1.0, 'passive'),
 ...
 'GALAXY_SOUNDS_DARK_MATTER': ('GALAXY_SOUNDS_PLANETARY_RINGS', 100, 0.9, 0.9, 1.0, 'passive'),
 'GALAXY_SOUNDS_BLACK_HOLES': ('GALAXY_SOUNDS_PLANETARY_RINGS', 100, 0.9, 0.9, -1.0, 'passive'),
 'GALAXY_SOUNDS_SOLAR_FLAMES': ('GALAXY_SOUNDS_PLANETARY_RINGS', 200, 0.9, 0.85, -1.0, 'passive'),
 'OXYGEN_SHAKE_MORNING_BREATH': ('OXYGEN_SHAKE_GARLIC', 100, 0.86, 1.0, 1.0, 'passive'),
 'OXYGEN_SHAKE_EVENING_BREATH': ('OXYGEN_SHAKE_GARLIC', 100, 0.9, 0.85, -1.0, 'passive'),
 'OXYGEN_SHAKE_MINT': ('OXYGEN_SHAKE_GARLIC', 200, 0.9, 0.85, -1.0, 'passive'),
 'OXYGEN_SHAKE_CHOCOLATE': ('OXYGEN_SHAKE_GARLIC', 200, 0.88, 0.9, -1.0, 'passive'),
 'SNACKPACK_RASPBERRY': ('SNACKPACK_STRAWBERRY', 200, 0.9, 0.8, 1.0, 'passive'),
 'SNACKPACK_CHOCOLATE': ('SNACKPACK_VANILLA', 200, 0.9, 0.8, 1.0, 'passive'),
 'SNACKPACK_PISTACHIO': ('SNACKPACK_STRAWBERRY', 200, 0.92, 0.7, 1.0, 'passive')}
    MAX_LEAD_LAG_PRODUCTS = 8
    def run(self, state: TradingState):
        cache = self.load_cache(state.traderData)
        result: Dict[str, List[Order]] = {}
        self.run_pebbles(state, cache, result)
        self.run_signals(state, cache, result)
        self.run_lead_lag(state, cache, result)
