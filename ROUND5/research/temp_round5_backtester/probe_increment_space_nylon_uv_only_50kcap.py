...
# Temporary executable 150k probe: probe_increment_space_nylon_uv_only
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ANCHOR_PRODUCTS = {'SLEEP_POD_NYLON', 'TRANSLATOR_SPACE_GRAY', 'TRANSLATOR_ECLIPSE_CHARCOAL', 'PEBBLES_L'}
