...
# Temporary fresh structural probe: probe_struct_portal_leadlag_trans_galaxy
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ...
    LEAD_LAG_CONFIG = {'TRANSLATOR_GRAPHITE_MIST': ('TRANSLATOR_SPACE_GRAY', 200, 0.82, 1.0, 1.0, 'passive'),
