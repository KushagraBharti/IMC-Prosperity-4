...
# Temporary microstructure fill probe: probe_microfill_portal_override_fresh_aggressive
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ...
    PEB_AGGRESSION = 1.08
    PEB_ALLOW_TAKE = 1
    SIGNAL_CONFIG = {'UV_VISOR_ORANGE': ('momentum', 200, 0.86, 1.25, 'passive'),
    ...
    MICRO_FILL_CONFIG = {'PANEL_1X2': (0.18, 0.8800000000000001, 6, 3, 'improve'),
 'PANEL_1X4': (0.18, 0.935, 6, 3, 'improve'),
 'PANEL_2X2': (0.18, 0.8800000000000001, 6, 3, 'improve'),
 'PANEL_2X4': (0.18, 1.1, 7, 3, 'improve'),
 'PANEL_4X4': (0.2, 0.9900000000000001, 6, 3, 'improve'),
 'SLEEP_POD_COTTON': (0.2, 0.935, 6, 3, 'improve'),
 'SLEEP_POD_POLYESTER': (0.18, 0.9900000000000001, 6, 3, 'improve'),
 'SLEEP_POD_SUEDE': (0.18, 1.1, 7, 3, 'improve'),
 'SLEEP_POD_LAMB_WOOL': (0.18, 0.9900000000000001, 6, 3, 'improve'),
 'SLEEP_POD_NYLON': (0.2, 0.8800000000000001, 6, 3, 'improve'),
 'TRANSLATOR_ASTRO_BLACK': (0.18, 1.045, 6, 3, 'improve'),
 'TRANSLATOR_SPACE_GRAY': (0.18, 1.1550000000000002, 7, 3, 'improve'),
 'GALAXY_SOUNDS_BLACK_HOLES': (0.18, 1.045, 6, 3, 'improve'),
 'GALAXY_SOUNDS_PLANETARY_RINGS': (0.2, 0.935, 6, 3, 'improve'),
 'OXYGEN_SHAKE_GARLIC': (0.18, 1.1, 6, 3, 'improve'),
 'OXYGEN_SHAKE_MINT': (0.18, 0.9900000000000001, 6, 3, 'improve'),
 'SNACKPACK_VANILLA': (0.18, 0.9900000000000001, 6, 3, 'improve'),
 'SNACKPACK_CHOCOLATE': (0.18, 0.9900000000000001, 6, 3, 'improve')}
    MAX_MICRO_FILL_PRODUCTS = 12
