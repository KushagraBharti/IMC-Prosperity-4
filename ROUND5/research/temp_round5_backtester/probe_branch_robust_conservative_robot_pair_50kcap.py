...
# Temporary executable 150k probe: probe_branch_robust_conservative_robot_pair
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ANCHOR_PRODUCTS = {'PEBBLES_L', 'TRANSLATOR_ECLIPSE_CHARCOAL'}
    ...
    SIGNAL_CONFIG = {'OXYGEN_SHAKE_GARLIC': ('reversal', 200, 0.82, 1.3, 'passive'),
     ...
     'ROBOT_DISHES': ('momentum', 25, 1.6, 0.38, 'passive'),
     'ROBOT_MOPPING': ('reversal', 25, 1.22, 0.3, 'passive')}
