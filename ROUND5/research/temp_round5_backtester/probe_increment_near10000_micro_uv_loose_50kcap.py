...
# Temporary executable 150k probe: probe_increment_near10000_micro_uv_loose
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ANCHOR_PRODUCTS = {'SNACKPACK_CHOCOLATE', 'PEBBLES_L', 'SNACKPACK_RASPBERRY', 'SNACKPACK_VANILLA', 'TRANSLATOR_SPACE_GRAY', 'TRANSLATOR_ECLIPSE_CHARCOAL', 'SLEEP_POD_NYLON'}
