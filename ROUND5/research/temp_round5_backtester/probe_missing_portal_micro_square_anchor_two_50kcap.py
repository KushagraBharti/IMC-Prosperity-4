...
# Temporary missing-mechanism executable probe: probe_missing_portal_micro_square_anchor_two
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ...
    PRODUCT_ANCHOR_CONFIG = {'MICROCHIP_SQUARE': (14250.0, 10.0, 5, 'two_sided', 'passive')}
