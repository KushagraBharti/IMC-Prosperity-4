...
# Temporary executable 150k probe: probe_grid_robust_micro_uv_passive_medium
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ...
    SIGNAL_CONFIG = {'OXYGEN_SHAKE_GARLIC': ('reversal', 200, 0.82, 1.3, 'passive'),
     ...
     'MICROCHIP_TRIANGLE': ('reversal', 150, 1.05, 0.55, 'passive'),
     'UV_VISOR_AMBER': ('momentum', 150, 0.88, 0.62, 'passive')}
