...
# Temporary fresh structural probe: probe_struct_portal_leadlag_curve_panel_sleep
class Trader:
    LIMIT = 10
    ANCHOR = 10000
 ...
 'SLEEP_POD_NYLON': ('SLEEP_POD_COTTON', 100, 0.92, 0.85, -1.0, 'passive')}
    ...
    SEMANTIC_CURVES = {'PANEL': (['PANEL_1X2', 'PANEL_1X4', 'PANEL_2X2', 'PANEL_2X4', 'PANEL_4X4'],
           {'PANEL_1X2': 2.0, 'PANEL_1X4': 4.0, 'PANEL_2X2': 4.2, 'PANEL_2X4': 8.0, 'PANEL_4X4': 16.0},
           {'PANEL_1X2': (1.15, 0.75, 'passive'),
            'PANEL_1X4': (1.1, 0.85, 'passive'),
            'PANEL_2X2': (1.1, 0.9, 'passive'),
            'PANEL_2X4': (1.0, 1.15, 'hybrid'),
            'PANEL_4X4': (1.2, 0.8, 'passive')}),
 'SLEEP': (['SLEEP_POD_COTTON', 'SLEEP_POD_POLYESTER', 'SLEEP_POD_SUEDE', 'SLEEP_POD_LAMB_WOOL', 'SLEEP_POD_NYLON'],
           {'SLEEP_POD_COTTON': 1.0,
            'SLEEP_POD_POLYESTER': 2.0,
            'SLEEP_POD_SUEDE': 3.0,
            'SLEEP_POD_LAMB_WOOL': 4.0,
            'SLEEP_POD_NYLON': 5.0},
           {'SLEEP_POD_POLYESTER': (1.1, 0.95, 'passive'),
            'SLEEP_POD_SUEDE': (1.05, 1.05, 'passive'),
            'SLEEP_POD_LAMB_WOOL': (1.1, 0.9, 'passive'),
            'SLEEP_POD_NYLON': (1.15, 0.8, 'passive')})}
    MAX_SEMANTIC_CURVE_PRODUCTS = 6
    def run(self, state: TradingState):
        ...
        self.run_semantic_curves(state, cache, result)
