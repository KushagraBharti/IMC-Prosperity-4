...
# Temporary fresh-edge pivot probe: probe_pivot_portal_resid_oxygen_snack_curve
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ...
    FRESH_CATEGORY_GROUPS = {'OXYGEN': ['OXYGEN_SHAKE_MORNING_BREATH',
 ...
 'SNACK': ['SNACKPACK_RASPBERRY',
           ...
           'SNACKPACK_VANILLA',
           'SNACKPACK_PISTACHIO']}
    FRESH_CATEGORY_PRODUCTS = {'OXYGEN_SHAKE_MINT': (1.1, 0.85, 'passive'),
