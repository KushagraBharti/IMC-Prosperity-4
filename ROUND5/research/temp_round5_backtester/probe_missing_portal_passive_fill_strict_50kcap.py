...
# Temporary missing-mechanism executable probe: probe_missing_portal_passive_fill_strict
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ...
    ONE_SIDED_FILL_CONFIG = {'OXYGEN_SHAKE_GARLIC': ('bid', 5, 0.35, 4, 4.0), 'UV_VISOR_YELLOW': ('ask', 5, 0.35, 4, 4.0), 'MICROCHIP_SQUARE': ('ask', 5, 0.25, 5, 4.0)}
