...
# Temporary microstructure fill probe: probe_microfill_portal_override_fresh_trans_gal_oxy_snack
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ...
    MICRO_FILL_CONFIG = {'TRANSLATOR_ASTRO_BLACK': (0.26, 0.95, 4, 3, 'improve'),
