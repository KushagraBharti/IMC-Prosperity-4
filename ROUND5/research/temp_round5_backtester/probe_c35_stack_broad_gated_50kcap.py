...
# Temporary executable 150k probe: probe_c35_stack_broad_gated
class Trader:
    LIMIT = 10
    PEBBLES = ['PEBBLES_XS', 'PEBBLES_S', 'PEBBLES_M', 'PEBBLES_L', 'PEBBLES_XL']
    PEB_X = {"PEBBLES_XS": 1.0, "PEBBLES_S": 2.0, "PEBBLES_M": 3.0, "PEBBLES_L": 4.0, "PEBBLES_XL": 5.0}
    PEB_BOOST = {'PEBBLES_XL': 1.15, 'PEBBLES_M': 1.24, 'PEBBLES_L': 1.12, 'PEBBLES_S': 0.92, 'PEBBLES_XS': 1.05}
    PEB_AGGRESSION = 1.1
    PEB_ALLOW_TAKE = 1
    SIGNAL_CONFIG = {'OXYGEN_SHAKE_GARLIC': ('reversal', 200, 0.82, 1.3, 'passive'),
     ...
     'PEBBLES_M': ('reversal', 200, 0.82, 1.2, 'passive'),
     'SLEEP_POD_SUEDE': ('reversal', 100, 0.96, 0.9, 'passive'),
     'MICROCHIP_CIRCLE': ('reversal', 100, 0.96, 0.85, 'passive'),
     'PANEL_2X4': ('momentum', 100, 0.88, 0.85, 'passive'),
     'ROBOT_LAUNDRY': ('reversal', 200, 0.96, 0.8, 'passive'),
     'UV_VISOR_MAGENTA': ('momentum', 50, 0.98, 0.7, 'passive'),
     'UV_VISOR_AMBER': ('momentum', 150, 0.9, 0.75, 'passive'),
     'GALAXY_SOUNDS_BLACK_HOLES': ('reversal', 50, 1.0, 0.65, 'passive'),
     'SNACKPACK_STRAWBERRY': ('reversal', 200, 1.08, 0.55, 'passive'),
     'ROBOT_VACUUMING': ('reversal', 200, 0.98, 0.6, 'passive')}
