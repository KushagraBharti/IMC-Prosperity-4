...
# Temporary passive-fill oracle probe: probe_mm_portal_replace_all_nonrobot
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ...
    PASSIVE_MM_CONFIG = {'PANEL_1X2': ('rolling', 120, 1.4, 4, 0.55, 3),
 'PANEL_1X4': ('rolling', 120, 1.4, 4, 0.55, 3),
 'PANEL_2X2': ('rolling', 120, 1.5, 4, 0.55, 3),
 'PANEL_2X4': ('rolling', 120, 1.3, 5, 0.5, 3),
 'PANEL_4X4': ('rolling', 120, 1.6, 4, 0.6, 3),
 'SLEEP_POD_COTTON': ('rolling', 160, 1.5, 4, 0.55, 3),
 'SLEEP_POD_POLYESTER': ('rolling', 160, 1.4, 4, 0.5, 3),
 'SLEEP_POD_SUEDE': ('rolling', 160, 1.3, 5, 0.5, 3),
 ...
 'TRANSLATOR_ASTRO_BLACK': ('rolling', 160, 1.4, 4, 0.5, 3),
 'TRANSLATOR_SPACE_GRAY': ('rolling', 160, 1.4, 5, 0.5, 3),
 ...
 'GALAXY_SOUNDS_BLACK_HOLES': ('rolling', 160, 1.4, 4, 0.5, 3),
 'GALAXY_SOUNDS_SOLAR_FLAMES': ('rolling', 160, 1.5, 4, 0.55, 3),
 'OXYGEN_SHAKE_MORNING_BREATH': ('rolling', 160, 1.4, 4, 0.5, 3),
 'OXYGEN_SHAKE_EVENING_BREATH': ('rolling', 160, 1.4, 4, 0.5, 3),
 'OXYGEN_SHAKE_MINT': ('rolling', 160, 1.4, 4, 0.5, 3),
 'OXYGEN_SHAKE_CHOCOLATE': ('rolling', 160, 1.4, 4, 0.5, 3),
 'OXYGEN_SHAKE_GARLIC': ('rolling', 160, 1.5, 4, 0.55, 3),
 'SNACKPACK_RASPBERRY': ('rolling', 160, 1.5, 3, 0.6, 3),
 'SNACKPACK_STRAWBERRY': ('rolling', 160, 1.5, 3, 0.6, 3),
 'SNACKPACK_CHOCOLATE': ('rolling', 160, 1.4, 3, 0.55, 3),
 'SNACKPACK_VANILLA': ('rolling', 160, 1.4, 3, 0.55, 3),
 'SNACKPACK_PISTACHIO': ('rolling', 160, 1.5, 3, 0.6, 3),
 ...
 'MICROCHIP_CIRCLE': ('rolling', 160, 1.6, 3, 0.6, 3)}
    PASSIVE_MM_OVERRIDE = True
