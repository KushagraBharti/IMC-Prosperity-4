...
# Temporary executable 150k probe: probe_c35_anchor_translator_family
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ANCHOR_PRODUCTS = {'TRANSLATOR_GRAPHITE_MIST', 'TRANSLATOR_VOID_BLUE', 'TRANSLATOR_ECLIPSE_CHARCOAL', 'TRANSLATOR_SPACE_GRAY'}
