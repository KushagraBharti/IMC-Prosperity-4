...
# Temporary fresh-edge pivot probe: probe_pivot_portal_fresh_oracle_all
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ...
    PEB_AGGRESSION = 1.08
    PEB_ALLOW_TAKE = 1
    SIGNAL_CONFIG = {'OXYGEN_SHAKE_GARLIC': ('momentum', 100, 0.78, 1.2, 'passive'),
     ...
     'GALAXY_SOUNDS_SOLAR_FLAMES': ('reversal', 200, 0.9, 0.95, 'passive'),
     'GALAXY_SOUNDS_SOLAR_WINDS': ('momentum', 100, 0.96, 0.8, 'passive'),
     ...
     'PANEL_2X2': ('momentum', 200, 0.9, 0.8, 'passive'),
     ...
     'OXYGEN_SHAKE_MINT': ('reversal', 200, 0.92, 0.8, 'passive'),
     ...
     'SLEEP_POD_LAMB_WOOL': ('momentum', 200, 0.86, 1.0, 'passive'),
     'SLEEP_POD_NYLON': ('reversal', 200, 0.9, 0.85, 'passive'),
     ...
     'TRANSLATOR_GRAPHITE_MIST': ('momentum', 50, 0.94, 1.0, 'passive'),
     'TRANSLATOR_VOID_BLUE': ('reversal', 50, 0.92, 0.95, 'passive'),
     'SLEEP_POD_POLYESTER': ('reversal', 200, 0.9, 1.05, 'passive'),
     'PANEL_2X4': ('momentum', 50, 0.76, 1.25, 'passive'),
     'SLEEP_POD_SUEDE': ('reversal', 100, 0.88, 1.1, 'passive'),
     'GALAXY_SOUNDS_BLACK_HOLES': ('reversal', 50, 0.92, 0.9, 'passive'),
     'TRANSLATOR_ASTRO_BLACK': ('momentum', 200, 0.92, 0.9, 'passive'),
     'SNACKPACK_STRAWBERRY': ('reversal', 200, 0.92, 1.0, 'passive'),
     'SNACKPACK_RASPBERRY': ('reversal', 200, 0.94, 0.9, 'passive'),
     'SNACKPACK_PISTACHIO': ('reversal', 200, 0.94, 0.8, 'passive'),
     ...
     'SNACKPACK_CHOCOLATE': ('momentum', 200, 0.92, 0.9, 'passive'),
     'SNACKPACK_VANILLA': ('momentum', 200, 0.96, 0.8, 'passive')}
    MAX_SIGNAL_PRODUCTS = 44
