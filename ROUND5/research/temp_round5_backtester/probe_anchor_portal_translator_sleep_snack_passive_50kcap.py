...
# Temporary broad 10000-anchor probe: probe_anchor_portal_translator_sleep_snack_passive
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ...
    BROAD_ANCHOR = 10000
    BROAD_ANCHOR_PRODUCTS = {'SLEEP_POD_SUEDE', 'SLEEP_POD_LAMB_WOOL', 'TRANSLATOR_ASTRO_BLACK', 'SNACKPACK_PISTACHIO', 'TRANSLATOR_SPACE_GRAY', 'SLEEP_POD_COTTON', 'SLEEP_POD_NYLON', 'SNACKPACK_RASPBERRY', 'TRANSLATOR_GRAPHITE_MIST', 'SNACKPACK_CHOCOLATE', 'SNACKPACK_STRAWBERRY', 'SNACKPACK_VANILLA', 'SLEEP_POD_POLYESTER', 'TRANSLATOR_VOID_BLUE'}
