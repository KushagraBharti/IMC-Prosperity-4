...
# Temporary fresh-edge pivot probe: probe_pivot_portal_resid_translator_galaxy_curve
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ...
    FRESH_CATEGORY_GROUPS = {'TRANSLATOR': ['TRANSLATOR_GRAPHITE_MIST',
 ...
 'GALAXY': ['GALAXY_SOUNDS_PLANETARY_RINGS',
    ...
    FRESH_CATEGORY_PRODUCTS = {'TRANSLATOR_ASTRO_BLACK': (1.1, 0.95, 'passive'),
