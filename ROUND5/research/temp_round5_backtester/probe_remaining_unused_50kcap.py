...
# Temporary executable 150k probe: probe_remaining_unused
class Trader:
    LIMIT = 10
    ...
    SIGNAL_CONFIG = {'OXYGEN_SHAKE_GARLIC': ('reversal', 200, 0.82, 1.3, 'passive'),
     ...
     'TRANSLATOR_SPACE_GRAY': ('momentum', 220, 0.86, 0.9, 'passive'),
     'TRANSLATOR_ECLIPSE_CHARCOAL': ('rolling_mean_reversion', 500, 0.9, 1.0, 'passive'),
     ...
     'OXYGEN_SHAKE_MINT': ('breakout_low_reversal', 500, 0.98, 0.7, 'passive'),
     ...
     'TRANSLATOR_ASTRO_BLACK': ('momentum', 100, 1.0, 0.7, 'passive')}
