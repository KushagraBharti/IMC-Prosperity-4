...
# Temporary regime-gap probe: probe_regime_portal_snack_regime
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ...
    REGIME_GAP_CONFIG = {'SNACKPACK_STRAWBERRY': ('reversal', 200, 0.9, 1.1, 'passive', 'imbalance_extreme', 0.42),
 'SNACKPACK_RASPBERRY': ('reversal', 200, 0.92, 0.95, 'passive', 'imbalance_extreme', 0.42),
 'SNACKPACK_PISTACHIO': ('reversal', 200, 0.94, 0.8, 'passive', 'imbalance_extreme', 0.42),
 'SNACKPACK_CHOCOLATE': ('momentum', 200, 0.92, 0.9, 'passive', 'spread_low', 10.0),
 'SNACKPACK_VANILLA': ('momentum', 200, 0.98, 0.7, 'passive', 'spread_low', 10.0)}
