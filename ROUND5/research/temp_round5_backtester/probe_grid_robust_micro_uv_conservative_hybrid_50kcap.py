...
# Temporary executable 150k probe: probe_grid_robust_micro_uv_conservative_hybrid
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ...
    SIGNAL_CONFIG = {'OXYGEN_SHAKE_GARLIC': ('reversal', 200, 0.82, 1.3, 'passive'),
     ...
     'MICROCHIP_TRIANGLE': ('reversal', 150, 1.15, 0.48, 'hybrid'),
     'UV_VISOR_AMBER': ('momentum', 150, 0.98, 0.52, 'hybrid')}
