...
# Temporary executable 150k probe: probe_grid_micro_uv_passive_loose
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ...
    SIGNAL_CONFIG = {'OXYGEN_SHAKE_GARLIC': ('reversal', 200, 0.82, 1.3, 'passive'),
     ...
     'MICROCHIP_TRIANGLE': ('reversal', 150, 0.82, 0.7, 'passive'),
     'UV_VISOR_AMBER': ('momentum', 150, 0.7, 0.76, 'passive')}
