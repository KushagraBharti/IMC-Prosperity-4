...
# Temporary executable 150k probe: probe_c35_stack_anchor_microtri_uvamber
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ...
    SIGNAL_CONFIG = {'OXYGEN_SHAKE_GARLIC': ('reversal', 200, 0.82, 1.3, 'passive'),
     ...
     'MICROCHIP_TRIANGLE': ('reversal', 150, 0.95, 0.6, 'hybrid'),
     'UV_VISOR_AMBER': ('momentum', 150, 0.75, 0.7, 'hybrid')}
