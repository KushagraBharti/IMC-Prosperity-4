...
# Temporary broad 10000-anchor probe: probe_anchor_portal_galaxy_oxygen_panel_passive
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ...
    BROAD_ANCHOR = 10000
    BROAD_ANCHOR_PRODUCTS = {'PANEL_1X4', 'GALAXY_SOUNDS_BLACK_HOLES', 'OXYGEN_SHAKE_MORNING_BREATH', 'PANEL_4X4', 'OXYGEN_SHAKE_EVENING_BREATH', 'PANEL_2X2', 'OXYGEN_SHAKE_GARLIC', 'OXYGEN_SHAKE_CHOCOLATE', 'GALAXY_SOUNDS_PLANETARY_RINGS', 'PANEL_2X4', 'GALAXY_SOUNDS_DARK_MATTER', 'PANEL_1X2', 'GALAXY_SOUNDS_SOLAR_WINDS', 'GALAXY_SOUNDS_SOLAR_FLAMES', 'OXYGEN_SHAKE_MINT'}
