...
# Temporary executable 150k probe: probe_c35_anchor_near10000_all
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ANCHOR_PRODUCTS = {'SNACKPACK_CHOCOLATE', 'SNACKPACK_RASPBERRY', 'PEBBLES_L', 'TRANSLATOR_SPACE_GRAY', 'TRANSLATOR_ECLIPSE_CHARCOAL', 'SLEEP_POD_NYLON', 'SNACKPACK_VANILLA'}
