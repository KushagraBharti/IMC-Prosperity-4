...
# Temporary fresh-edge pivot probe: probe_pivot_portal_resid_all_fresh
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ...
    FRESH_CATEGORY_GROUPS = {'SLEEP': ['SLEEP_POD_COTTON', 'SLEEP_POD_POLYESTER', 'SLEEP_POD_SUEDE', 'SLEEP_POD_LAMB_WOOL', 'SLEEP_POD_NYLON'],
 'PANEL': ['PANEL_1X2', 'PANEL_1X4', 'PANEL_2X2', 'PANEL_2X4', 'PANEL_4X4'],
 'TRANSLATOR': ['TRANSLATOR_GRAPHITE_MIST',
                'TRANSLATOR_VOID_BLUE',
                'TRANSLATOR_ASTRO_BLACK',
                'TRANSLATOR_SPACE_GRAY',
                'TRANSLATOR_ECLIPSE_CHARCOAL'],
 'GALAXY': ['GALAXY_SOUNDS_PLANETARY_RINGS',
            'GALAXY_SOUNDS_SOLAR_WINDS',
            'GALAXY_SOUNDS_DARK_MATTER',
            'GALAXY_SOUNDS_BLACK_HOLES',
            'GALAXY_SOUNDS_SOLAR_FLAMES'],
 'OXYGEN': ['OXYGEN_SHAKE_MORNING_BREATH',
 ...
 'SNACK': ['SNACKPACK_RASPBERRY',
           ...
           'SNACKPACK_VANILLA',
           'SNACKPACK_PISTACHIO']}
    FRESH_CATEGORY_PRODUCTS = {'SLEEP_POD_POLYESTER': (1.1, 0.95, 'passive'),
 'SLEEP_POD_SUEDE': (1.05, 1.05, 'passive'),
 'SLEEP_POD_LAMB_WOOL': (1.1, 0.85, 'passive'),
 'SLEEP_POD_NYLON': (1.15, 0.75, 'passive'),
 'PANEL_1X2': (1.2, 0.75, 'passive'),
 'PANEL_1X4': (1.15, 0.8, 'passive'),
 'PANEL_2X2': (1.15, 0.85, 'passive'),
 'PANEL_2X4': (1.05, 1.1, 'hybrid'),
 'PANEL_4X4': (1.2, 0.8, 'passive'),
 'TRANSLATOR_ASTRO_BLACK': (1.1, 0.95, 'passive'),
 'TRANSLATOR_SPACE_GRAY': (1.15, 0.9, 'passive'),
 'TRANSLATOR_VOID_BLUE': (1.15, 0.8, 'passive'),
 'GALAXY_SOUNDS_BLACK_HOLES': (1.1, 0.9, 'passive'),
 'GALAXY_SOUNDS_SOLAR_WINDS': (1.15, 0.75, 'passive'),
 'GALAXY_SOUNDS_SOLAR_FLAMES': (1.15, 0.75, 'passive'),
 'OXYGEN_SHAKE_MINT': (1.1, 0.85, 'passive'),
 'OXYGEN_SHAKE_EVENING_BREATH': (1.1, 0.8, 'passive'),
 'SNACKPACK_VANILLA': (1.05, 0.9, 'passive'),
 'SNACKPACK_CHOCOLATE': (1.05, 0.9, 'passive'),
 'SNACKPACK_RASPBERRY': (1.1, 0.75, 'passive'),
 'SNACKPACK_PISTACHIO': (1.1, 0.65, 'passive')}
    MAX_FRESH_CATEGORY_PRODUCTS = 9
