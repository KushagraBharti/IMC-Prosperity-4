...
# Temporary regime-gap probe: probe_regime_portal_uv_sleep_gal_regime
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ...
    REGIME_GAP_CONFIG = {'UV_VISOR_MAGENTA': ('momentum', 50, 0.86, 1.0, 'passive', 'imbalance_extreme', 0.45),
 ...
 'SLEEP_POD_POLYESTER': ('reversal', 200, 0.88, 1.0, 'passive', 'imbalance_extreme', 0.42),
 'SLEEP_POD_LAMB_WOOL': ('momentum', 200, 0.86, 0.95, 'passive', 'imbalance_extreme', 0.42),
 'GALAXY_SOUNDS_BLACK_HOLES': ('reversal', 50, 0.86, 1.0, 'passive', 'imbalance_extreme', 0.45),
 'GALAXY_SOUNDS_SOLAR_FLAMES': ('reversal', 200, 0.88, 0.9, 'passive', 'spread_low', 12.0)}
