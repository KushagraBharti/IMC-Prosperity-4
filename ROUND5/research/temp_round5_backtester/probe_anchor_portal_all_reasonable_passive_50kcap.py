...
# Temporary broad 10000-anchor probe: probe_anchor_portal_all_reasonable_passive
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ...
    BROAD_ANCHOR = 10000
    BROAD_ANCHOR_PRODUCTS = {'UV_VISOR_YELLOW', 'MICROCHIP_TRIANGLE', 'MICROCHIP_SQUARE', 'UV_VISOR_MAGENTA', 'OXYGEN_SHAKE_MINT', 'PANEL_1X4', 'UV_VISOR_ORANGE', 'OXYGEN_SHAKE_MORNING_BREATH', 'ROBOT_VACUUMING', 'PANEL_4X4', 'OXYGEN_SHAKE_EVENING_BREATH', 'TRANSLATOR_ASTRO_BLACK', 'SNACKPACK_PISTACHIO', 'ROBOT_IRONING', 'UV_VISOR_RED', 'MICROCHIP_OVAL', 'ROBOT_MOPPING', 'GALAXY_SOUNDS_SOLAR_WINDS', 'GALAXY_SOUNDS_BLACK_HOLES', 'OXYGEN_SHAKE_GARLIC', 'MICROCHIP_RECTANGLE', 'SLEEP_POD_COTTON', 'SLEEP_POD_NYLON', 'SNACKPACK_CHOCOLATE', 'GALAXY_SOUNDS_PLANETARY_RINGS', 'PANEL_1X2', 'GALAXY_SOUNDS_SOLAR_FLAMES', 'TRANSLATOR_VOID_BLUE', 'SLEEP_POD_SUEDE', 'SLEEP_POD_LAMB_WOOL', 'PANEL_2X2', 'ROBOT_LAUNDRY', 'OXYGEN_SHAKE_CHOCOLATE', 'TRANSLATOR_SPACE_GRAY', 'PANEL_2X4', 'SNACKPACK_RASPBERRY', 'GALAXY_SOUNDS_DARK_MATTER', 'TRANSLATOR_GRAPHITE_MIST', 'UV_VISOR_AMBER', 'SNACKPACK_STRAWBERRY', 'MICROCHIP_CIRCLE', 'SNACKPACK_VANILLA', 'SLEEP_POD_POLYESTER'}
    BROAD_ANCHOR_OVERRIDE = False
    BROAD_ANCHOR_TAKE_EDGE = 12
    BROAD_ANCHOR_PASSIVE_EDGE = 3
    BROAD_ANCHOR_SIZE = 3
