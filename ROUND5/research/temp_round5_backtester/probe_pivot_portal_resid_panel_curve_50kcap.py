...
# Temporary fresh-edge pivot probe: probe_pivot_portal_resid_panel_curve
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ...
    FRESH_CATEGORY_GROUPS = {'PANEL': ['PANEL_1X2', 'PANEL_1X4', 'PANEL_2X2', 'PANEL_2X4', 'PANEL_4X4']}
    FRESH_CATEGORY_PRODUCTS = {'PANEL_1X2': (1.2, 0.75, 'passive'),
