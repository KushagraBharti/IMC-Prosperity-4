...
# Temporary executable 150k probe: probe_c35_anchor_space_nylon
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ANCHOR_PRODUCTS = {'PEBBLES_L', 'TRANSLATOR_SPACE_GRAY', 'TRANSLATOR_ECLIPSE_CHARCOAL', 'SLEEP_POD_NYLON'}
