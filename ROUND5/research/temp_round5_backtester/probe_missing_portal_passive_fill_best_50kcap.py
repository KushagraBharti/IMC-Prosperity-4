...
# Temporary missing-mechanism executable probe: probe_missing_portal_passive_fill_best
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ...
    ONE_SIDED_FILL_CONFIG = {'PEBBLES_XL': ('bid', 3, 0.05, 4, 4.0), 'OXYGEN_SHAKE_GARLIC': ('bid', 3, 0.05, 4, 4.0), 'UV_VISOR_YELLOW': ('ask', 3, 0.05, 4, 4.0), 'MICROCHIP_SQUARE': ('ask', 3, 0.05, 5, 4.0)}
