...
# Temporary executable 150k probe: probe_c36_more_pebbles
class Trader:
    LIMIT = 10
    ANCHOR = 10_000
    ...
    TRADED_PEBBLES = {'PEBBLES_L', 'PEBBLES_M', 'PEBBLES_XL', 'PEBBLES_S', 'PEBBLES_XS'}
    PEB_BOOST = {'PEBBLES_XL': 1.15, 'PEBBLES_M': 1.08, 'PEBBLES_S': 1.12, 'PEBBLES_L': 1.0, 'PEBBLES_XS': 0.92}
    ...
    MOMENTUM_EXTRAS = {'TRANSLATOR_SPACE_GRAY': (220, 0.7, 0.8),
     ...
     'PEBBLES_L': (120, 0.85, 0.65),
     'PEBBLES_M': (180, 0.75, -0.65)}
