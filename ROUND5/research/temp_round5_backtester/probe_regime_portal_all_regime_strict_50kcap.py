...
# Temporary executable 150k probe: probe_increment_vanilla_micro_uv_loose
# Temporary regime-gap probe: probe_regime_portal_all_regime_strict
class Trader:
    LIMIT = 10
    ANCHOR = 10000
    ANCHOR_PRODUCTS = {'PEBBLES_L', 'SNACKPACK_VANILLA', 'TRANSLATOR_ECLIPSE_CHARCOAL'}
    ...
    REGIME_GAP_CONFIG = {'SNACKPACK_STRAWBERRY': ('reversal', 200, 1.02, 0.935, 'passive', 'imbalance_extreme', 0.54),
 'SNACKPACK_RASPBERRY': ('reversal', 200, 1.04, 0.8075, 'passive', 'imbalance_extreme', 0.54),
 'SNACKPACK_PISTACHIO': ('reversal', 200, 1.06, 0.68, 'passive', 'imbalance_extreme', 0.54),
 'SNACKPACK_CHOCOLATE': ('momentum', 200, 1.04, 0.765, 'passive', 'spread_low', 8.0),
 'SNACKPACK_VANILLA': ('momentum', 200, 1.1, 0.595, 'passive', 'spread_low', 8.0),
 'UV_VISOR_MAGENTA': ('momentum', 50, 0.98, 0.85, 'passive', 'imbalance_extreme', 0.5700000000000001),
 'UV_VISOR_YELLOW': ('reversal', 200, 1.0, 0.7224999999999999, 'passive', 'spread_low', 9.0),
 'SLEEP_POD_SUEDE': ('reversal', 100, 0.96, 0.9774999999999999, 'passive', 'spread_low', 9.0),
 'SLEEP_POD_POLYESTER': ('reversal', 200, 1.0, 0.85, 'passive', 'imbalance_extreme', 0.54),
 'SLEEP_POD_LAMB_WOOL': ('momentum', 200, 0.98, 0.8075, 'passive', 'imbalance_extreme', 0.54),
 'GALAXY_SOUNDS_BLACK_HOLES': ('reversal', 50, 0.98, 0.85, 'passive', 'imbalance_extreme', 0.5700000000000001),
 'GALAXY_SOUNDS_SOLAR_FLAMES': ('reversal', 200, 1.0, 0.765, 'passive', 'spread_low', 10.0),
 'OXYGEN_SHAKE_EVENING_BREATH': ('reversal', 100, 0.96, 0.85, 'passive', 'spread_low', 10.0),
 'OXYGEN_SHAKE_MINT': ('reversal', 200, 1.0, 0.765, 'passive', 'spread_low', 10.0),
 'OXYGEN_SHAKE_MORNING_BREATH': ('momentum', 200, 0.98, 0.8075, 'passive', 'spread_low', 10.0),
 'OXYGEN_SHAKE_CHOCOLATE': ('reversal', 200, 0.98, 0.8075, 'passive', 'imbalance_extreme', 0.54)}
    REGIME_GAP_OVERRIDE = False
    MAX_REGIME_GAP_PRODUCTS = 10
