...
# Temporary executable 150k probe: probe_c36_focus_gap_signals
class Trader:
    LIMIT = 10
    ANCHOR = 10_000
    ...
    SIGNAL_CONFIG = {'UV_VISOR_ORANGE': ('momentum', 100, 1.0, 1.0),
     'SLEEP_POD_COTTON': ('momentum', 100, 1.0, 0.95),
     ...
     'SLEEP_POD_NYLON': ('reversal', 100, 1.05, 0.7),
