...
function Normalize-RoundKey {
    ...
    switch ($normalized) {
        ...
        "4" { return "round4" }
        "round4" { return "round4" }
        "round_4" { return "round4" }
        "5" { return "round5" }
        "round5" { return "round5" }
        "round_5" { return "round5" }
...
function Get-RoundConfig {
    ...
    if ($null -eq $roundConfig) {
        throw "Unknown round key '$Round'. Valid values: tutorial, round1, round2, round3, round4, round5."
    }
