...
4. Run Rust as a third replay implementation when you want another simulator baseline.
5. Compare the replay outputs or compare against official bundles.
6. Open the latest log in a visualizer.
7. When a tutorial strategy looks stable, run Monte Carlo:
...
- Chris Monte Carlo is tutorial-round only. The root `main.py` runner skips it automatically on non-tutorial replay rounds unless you force it.
