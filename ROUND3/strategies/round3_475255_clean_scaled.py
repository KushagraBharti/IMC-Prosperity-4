...
class Trader:
    ...
    VELVET_TRADE_START_TIMESTAMP = 5_000
    OPTION_TRADE_START_TIMESTAMP = 5_000
    ...
    OPTION_SIZE = 20
    WEAK_OPTION_EXIT_TIMESTAMP = 600_000
    WEAK_OPTION_EXIT_SET = {"VEV_5200", "VEV_5300", "VEV_5500"}
    ...
    def run(self, state: TradingState):
        ...
        if velvet_book and velvet_book["has_both_sides"]:
            ...
            velvet_fair = 0.35 * velvet_linear_fair + 0.65 * velvet_implied_fair
        ...
        if timestamp >= self.OPTION_TRADE_START_TIMESTAMP:
            option_orders = self.trade_vouchers_relative(books, state.position, velvet_fair, t_years, timestamp)
